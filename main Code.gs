/**
 * =========================================================================
 * SMART GEM ASSESSMENT ENGINE - MASTER UNIFIED SCRIPT
 * =========================================================================
 */
...
function stage5_DeployExam() {
  ...
  let examPayload = { fileName: fileName, description: `${subject} Mastery - ${chapter} (${targetGrade})`, questions: approvedQuestions, durationMinutes: currentDuration };
  ...
  let baseAppUrl = "https://script.google.com/macros/s/AKfycbzeXXXpDNGEQzKKiK9arTNEf_a-oMiU3QH_6A0tBq1623HX4AU2XSf5TKEZZ1bxk92L/exec";
...
function autoGenerateReportCard(e) {
  ...
  try {
    ...
    let brandPara = docBody.appendParagraph(dash.getRange("B9").getValue() || "Classes by CMA Tarun Singhal");
    ...
    docBody.appendParagraph("Guided by 27 Years of Teaching Excellence").setAlignment(DocumentApp.HorizontalAlignment.CENTER).setItalic(true).editAsText().setFontSize(11).setForegroundColor("#57606a").setFontFamily("Arial");
